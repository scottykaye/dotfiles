...
| `<leader>ma` | Match: Search and Replace (floating) |
| `<leader>mw` | Match: Word under cursor (floating) |
| `<leader>ml` | Match: Current line (floating) |
...
| `<M-n>` | i | Next suggestion |
| `<M-p>` | i | Previous suggestion |
