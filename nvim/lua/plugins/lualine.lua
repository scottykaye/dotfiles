...
-- -- oxocarbon
rose_pine.normal.c = { fg = rose_pine.normal.a.fg, bg = "#ff66b2", gui = "bold" }
rose_pine.insert.c = { fg = rose_pine.normal.a.fg, bg = "#3aa7ff", gui = "bold" }
rose_pine.visual.c = { fg = rose_pine.normal.a.fg, bg = "#9b6bff", gui = "bold" }
